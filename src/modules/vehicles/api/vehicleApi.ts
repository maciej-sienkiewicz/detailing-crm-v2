...
export const vehicleApi = {
    ...
    getDeletedVisits: async (vehicleId: string): Promise<{ visits: Array<{ id: string; title?: string | null; description: string; date: string; customerName: string; status: string; totalCost: { grossAmount: number; currency: string }; deletedAt?: string | null }> }> => {
