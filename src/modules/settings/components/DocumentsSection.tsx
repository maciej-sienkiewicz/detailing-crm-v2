...
export function DocumentsSection() {
    ...
    const isLoading = canManage && (loadingTemplates || loadingRules || loadingDefinitions);
    ...
    const handleAdd = (stage: ProtocolStage) => { setAddStage(stage); setModalOpen(true); };
    const handleRefresh = () => { refetchTemplates(); refetchRules(); refetchDefinitions(); };
