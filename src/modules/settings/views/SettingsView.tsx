...
const SECTION_HELP: Partial<Record<SectionId, HelpContent>> = {
    ...
    templates:       MESSAGE_TEMPLATES_HELP,
...
const SECTION_REQUIREMENTS: Partial<Record<SectionId, AccessRequirement>> = {
    ...
    // Automat zakłada leady w imieniu studia i kosztuje — jak każde ustawienie,
    // które zmienia zawartość CRM-a bez udziału człowieka, zostaje przy właścicielu.
