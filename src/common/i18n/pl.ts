...
export const pl: TranslationKeys = {
    ...
    customers: {
        ...
        detail: {
            ...
            activity: 'Historia',
            settings: 'Ustawienia',
            totalRevenue: 'Zrealizowany przychód',
    ...
    checkin: {
        ...
        photos: {
            ...
            subtitle: 'Dodaj zdjęcia pojazdu (opcjonalne)',
    ...
    auth: {
        ...
        forgotPassword: {
            ...
            subtitle: 'Podaj swój adres email, a wyślemy Ci link do zresetowania hasła',
            emailLabel: 'Adres email',
            emailPlaceholder: 'twoj@email.com',
            submitButton: 'Wyślij link resetujący',
            submitting: 'Wysyłanie...',
            successMessage: 'Jeśli konto o podanym adresie e-mail istnieje, wyślemy na nie wiadomość z linkiem do zresetowania hasła.',
        ...
        resetPassword: {
            ...
            successMessage: 'Hasło zostało zmienione. Możesz teraz zalogować się przy użyciu nowego hasła.',
            successAction: 'Przejdź do logowania',
            expiredTitle: 'Link wygasł',
            expiredMessage: 'Ten link do resetowania hasła jest nieprawidłowy lub wygasł. Wróć do formularza i spróbuj ponownie.',
            expiredAction: 'Wróć do przypomnij hasło',
        },
        confirmPassword: {
            title: 'Aktywuj konto',
            subtitle: 'Ustaw hasło, aby aktywować swoje konto w DetailBoost',
            passwordLabel: 'Hasło',
            passwordPlaceholder: 'Minimum 8 znaków',
            confirmPasswordLabel: 'Potwierdź hasło',
            confirmPasswordPlaceholder: 'Wprowadź hasło ponownie',
            ...
            submitting: 'Zapisywanie...',
            successMessage: 'Konto zostało aktywowane. Możesz teraz zalogować się.',
            successAction: 'Przejdź do logowania',
            expiredTitle: 'Link wygasł',
            expiredMessage: 'Ten link aktywacyjny jest nieprawidłowy lub wygasł. Skontaktuj się z administratorem, aby ponownie wysłał zaproszenie.',
            expiredAction: 'Wróć do logowania',
        },
        validation: {
    ...
    statistics: {
        ...
        categories: {
            ...
            error: 'Nie udało się załadować kategorii. Spróbuj ponownie.',
        ...
        categoryForm: {
            titleCreate: 'Nowa kategoria',
            titleEdit: 'Edytuj kategorię',
            nameLabel: 'Nazwa kategorii',
            namePlaceholder: 'np. Mechanika Podwoziowa',
            nameRequired: 'Nazwa kategorii jest wymagana',
            nameMin: 'Nazwa musi mieć minimum 2 znaki',
            descriptionLabel: 'Opis (opcjonalnie)',
            descriptionPlaceholder: 'Krótki opis zakresu usług w tej kategorii...',
